        ...
        <div className="footer__row">
          <div className="footer__column">
            <div className="footer__column-1">
              <h3 className="footer__name">CÔNG TY CỔ PHẦN CANIFA</h3>
              ...
              <p className="footer__title-1">Fax: +8424 - 6277.6419</p>
              <p className="footer__title-1">Địa chỉ email: hello@canifa.com</p>
            </div>

            <div className="footer__column-2">
              <h3 className="footer__name">THƯƠNG HIỆU</h3>
              <ul className="footer__title-list">
                <li className="footer__title-item">Giới thiệu</li>
                <li className="footer__title-item">Tin tức</li>
                <li className="footer__title-item">Tuyển dụng</li>
                <li className="footer__title-item">Với cộng đồng</li>
                <li className="footer__title-item">Hệ thống cửa hàng</li>
            ...
            <div className="footer__column-3">
              ...
              <ul className="footer__title-list">
                ...
                <li className="footer__title-item">Chính sách KHTT</li>
                <li className="footer__title-item">Chính sách vận chuyển</li>
                <li className="footer__title-item">Hướng dẫn chọn size</li>
                <li className="footer__title-item">Kiểm tra đơn hàng</li>
                <li className="footer__title-item">Quy định đổi hàng</li>
                <li className="footer__title-item">Tra cứu điểm thẻ</li>
                <li className="footer__title-item">Chính sách bảo mật</li>
              </ul>
            </div>
            ...
            <div className="footer__column-4">
              ...
              <div className="footer__code">
                ...
                {/* eslint-disable-next-line @next/next/no-html-link-for-pages */}
                <a href="/" className="footer__code-link">
                  <img src="./asset/img/code/appstore.png" alt="App Store" />
                </a>
              </div>

              <h3 className="footer__name">Phương thức thanh toán</h3>
              <div className="footer__visa">
                <img src="./asset/img/code/pay.svg" alt="Payment methods" />
              </div>
